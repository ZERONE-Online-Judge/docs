...
- 유형은 대회 이름과 일정만 공유하고, 문제/제출/스코어보드/채점 이력은 유형별로 분리한다.
- 팀 등록 시 운영자가 유형을 반드시 지정한다.
- 참가팀은 대회 중 하나의 유형만 가질 수 있다.
...
- 대회 중 재채점은 가능하다.
- 대회 운영자와 대회 운영매니저는 재채점을 요청할 수 없다.
- 재채점 권한은 서비스 관리자 또는 채점 인프라 권한으로만 둔다.
